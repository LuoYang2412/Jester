// V-E1-DPLY-WS-02 at 09/05/2016 06:22:49
'use strict';
if (typeof veTagData === 'undefined') {
    var veTagData = (function () {
        var b,
            ...
            d = {
                journeycode: '53B4DC8A-E56D-4AB3-B1AA-BAB329637B6A',
  ...
  Forms: [
    {
      ...
      FormTypeId: 1,
      FormURLs: [
        "evisu.com/customer/account/login/",
        "evisu.com/eu/customer/account/login/",
        "evisu.com/us/customer/account/login/"
      ],
    ...
    },
    {
      ...
      FormTypeId: 1,
      FormURLs: [
        "evisu.com/customer/account/create/",
        "evisu.com/eu/customer/account/create",
        "evisu.com/us/customer/account/create/"
      ],
      IdentifyAbandonmentOr: true,
      NumberIdentifiedFields: 0,
      Name: null,
    ...
    },
    {
      ...
      FormFields: [
        ...
        {
          ClientFieldName: ".free-shipping-msg",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 68474,
          HtmlAttributeTag: "Value",
        ...
        {
          ClientFieldName: ".grand-total .price",
          DomEvent: "DynamicActivity",
          FieldTypeName: "Raw",
          FormMappingId: 78366,
          HtmlAttributeTag: "Value",
        ...
        {
          ClientFieldName: ".onestepcheckout-totals .price:first",
          DomEvent: "DynamicActivity",
          FieldTypeName: "Raw",
          FormMappingId: 90510,
          HtmlAttributeTag: "Value",
        ...
        {
          ClientFieldName: ".product-name .second-name",
          DomEvent: "OnLoad",
          FieldTypeName: "RawSeries",
          FormMappingId: 154103,
          HtmlAttributeTag: "Value",
          HtmlType: "span",
          IdentifyAbandonment: false,
          isEmail: false,
        ...
        {
          ClientFieldName: ".product-details .price",
          DomEvent: "OnLoad",
          FieldTypeName: "RawSeries",
          FormMappingId: 154105,
          HtmlAttributeTag: "Value",
          HtmlType: "span",
          IdentifyAbandonment: false,
          isEmail: false,
        ...
        {
          ClientFieldName: ".item-holder img",
          DomEvent: "OnLoad",
          FieldTypeName: "RawSeries",
          FormMappingId: 154109,
        ...
        {
          ClientFieldName: "onestepcheckout-title",
          DomEvent: "OnLoad",
          FieldTypeName: "Class",
          FormMappingId: 221297,
          HtmlAttributeTag: "Value",
          HtmlType: "h1",
          IdentifyAbandonment: false,
          isEmail: false,
        ...
        {
          ClientFieldName: "#cartHeader .link-qty",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 266279,
          HtmlAttributeTag: "Value",
          HtmlType: "span",
          IdentifyAbandonment: false,
          isEmail: false,
        ...
        {
          ClientFieldName: ".product-name .second-name:first",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 266284,
          HtmlAttributeTag: "Value",
          HtmlType: "span",
          IdentifyAbandonment: false,
          isEmail: false,
        ...
        {
          ClientFieldName: ".product-name a:first",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 266285,
          HtmlAttributeTag: "href",
          HtmlType: "a",
          IdentifyAbandonment: false,
          isEmail: false,
        ...
        {
          ClientFieldName: ".item-holder img:first",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 266287,
          HtmlAttributeTag: "src",
          HtmlType: "img",
          IdentifyAbandonment: false,
          isEmail: false,
          FormMappingTypeId: 14,
          HtmlPath: ""
        },
        {
          ClientFieldName: ".product-details .price:first",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 266288,
          HtmlAttributeTag: "Value",
          HtmlType: "span",
          IdentifyAbandonment: false,
          isEmail: false,
      ...
      FormTypeId: 1,
      FormURLs: [
        "evisu.com/onestepcheckout/",
        "evisu.com/*/onestepcheckout/",
        "evisu.com/checkout/cart/",
        "evisu.com/*/checkout/cart/"
      ],
      IdentifyAbandonmentOr: true,
      NumberIdentifiedFields: 0,
    ...
    },
    {
      ...
      FormFields: [
        {
          ClientFieldName: ".col-main p:contains('order #')",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 66142,
          HtmlAttributeTag: "Value",
        ...
        {
          ClientFieldName: ".col-main p a:first",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 275234,
          HtmlAttributeTag: "Value",
          HtmlType: "a",
          IdentifyAbandonment: false,
          isEmail: false,
      ...
      FormTypeId: 2,
      FormURLs: [
        "evisu.com/checkout/onepage/success/",
        "evisu.com/checkout/eu/onepage/success/",
        "evisu.com/checkout/us/onepage/success/",
        "evisu.com/eu/checkout/onepage/success/",
        "evisu.com/us/checkout/onepage/success/",
        "evisu.com/checkout/onepage/success/",
        "evisu.com/*/checkout/onepage/success/",
        "evisu.com/checkout/onepage/success",
        "evisu.com/*/checkout/onepage/success"
    ...
    },
    {
      ...
      FormFields: [
        ...
        {
          ClientFieldName: "#main-image img",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 68439,
          HtmlAttributeTag: "src",
        ...
        {
          ClientFieldName: "p\t#collateral-tabs>.tab-container:eq(0) div",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 68441,
          HtmlAttributeTag: "Value",
        ...
        {
          ClientFieldName: ".summary-info .subtotal .price",
          DomEvent: "DynamicActivity",
          FieldTypeName: "Raw",
          FormMappingId: 154101,
          HtmlAttributeTag: "Value",
          HtmlType: "span",
          IdentifyAbandonment: false,
          isEmail: false,
    ...
    },
    {
      ...
      FormFields: [
        ...
        {
          ClientFieldName: ".more-views a img:first",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 88578,
          HtmlAttributeTag: "src",
        ...
        {
          ClientFieldName: "#product-second-name,.product-second-name",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 88580,
          HtmlAttributeTag: "Value",
        ...
        {
          ClientFieldName: ".product-main-info .price-box .price:last",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 88588,
          HtmlAttributeTag: "Value",
        ...
        {
          ClientFieldName: ".breadcrumbs li:eq(-2)",
          DomEvent: "OnLoad",
          FieldTypeName: "Raw",
          FormMappingId: 88598,
          HtmlAttributeTag: "Value",
  ...
  OptOutField: 0
                 ...
                 */
                settings: {consoleMessagesEnabled:true, 
elementsToIgnore:['.onestepcheckout-place-order-wrapper #onestepcheckout-place-order'],
elementsStoppingAppsOnClick: ['.onestepcheckout-place-order-wrapper *', '.payment-methods *'],
elementsStoppingAppsOnMouseDown: ['.onestepcheckout-place-order-wrapper *', '.payment-methods *'],
domainsToIgnore: ['evisu.com' ], unsupportedBrowsersVersionPlatform: { 'ie' : ['8'] },

//veChat
appsForms:[{
 appName: 'chat',
 appAgents: ["10603","10616","11590"],
 priority: 1,
 ...
 FormId: 20238,
 FormTypeId: 6,
 FormURLs: ["evisu.com/*/onestepcheckout/","evisu.com/onestepcheckout/"],
 Paremeter: []
}],

animations: {"entry":{"main":"ve-bouncein","cta":"ve-bounceindown","proactivecta":""},"hover":{"main":"","cta":"","close":"","submit":""},"loop":{"main":"ve-swingloop","cta":"ve-bounceloop","proactivecta":"","close":"","submit":""}},
veAds: {
                    config: {
                    timeStamp: "Mon Jan 11 2016 17:08:22 GMT+0800 (China Standard Time)",
                    version: "2.0.0",
                    uuid: "jor",
                    avoidDOM: false,
	...
	},
	{
		...
		capture:{
			type: "selector",
			mappingCriteria: "contains",
			element: ".col-main p:contains('order #')",
			keepChecking: false,
			useMappings: false
		},
		pages:[1]
